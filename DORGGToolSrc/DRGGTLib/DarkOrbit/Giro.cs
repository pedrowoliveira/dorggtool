...
namespace DRGGTLib.DarkOrbit
{
    public class Giro
    {
        ...
        public List<Multiplicador> Multiplicadores { get; set; }

        // Promocões?
        public bool EmPromocao { get; set; }
        public double FatorDeDesconto { get; set; }
        public bool RecompensaEmDobro { get; set; }
        public bool DiaDePortal { get; set; }
        ...
        public Giro(){}
        public Giro(int portal, int numeroDeGiros, List<Multiplicador> multiplicadores = null, bool emPromocao = false, double fatorDeDesconto = 0.0, bool recompensaEmDobro = false, bool diaDePortal = false)
        {
